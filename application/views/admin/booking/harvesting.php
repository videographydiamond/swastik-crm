                     ...
                     <div class="col-sm-12">
                        <div class="d-flex flex-wrap gap-2 table-responsive">
                           <div class="btn-group" role="group" aria-label="Basic example">
                              <a  class="btn my-primary px-4" href="<?php echo base_url()?>admin/bookings/export?manage_booking_type=harvesting<?php echo $_SERVER['QUERY_STRING'];?>">Export Booking</a>
                              <a hidden   class="btn my-primary px-4" href="<?php echo base_url()?>admin/bookings/advance" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg"><i class="fa fa-filter" aria-hidden="true"></i>Advance Search</a> 
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="card">
                     <h5 class="card-header bg-success text-white border-bottom ">
                        <div class="row ">
                           ...
                           <div class="col-sm-3">
                              <a href="<?php echo base_url()?>admin/harvesting_management" class="btn btn-info btn-sm">Clear</a> 
                     ...
                     <div class="card-body pb-0">
                        <div class="table-responsive mytablestyle">
                           <form method="GET" action="<?php echo base_url()?>admin/harvesting_management" id="booking_filter">
