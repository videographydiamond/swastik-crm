    ...
    <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                     <h4 class="mb-sm-0 font-size-18">Farmer Type</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a  href="<?php echo base_url()?>admin">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a   href="<?php echo base_url()?>admin/farmer_type">Farmer Type List</a></li>
                                            <li class="breadcrumb-item active">Add New Farmer Type</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
      ...
      <div class="row">
          <div class="col-xl-12">
            ...
            <div class="row">
               <div class="col-lg-12">
                 <form  action="<?php echo base_url() ?>admin/farmer_type/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                  <div class="card">
                  ...
                  <div class="col-sm-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input type="text"  class="form-control form-control-sm" id="name" name="name" placeholder="Farmer Type Name*" value="<?php echo set_value('name')?>" required="">
                              </div>
                           </div>
                       </div>
