                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Edit Farmer Type</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
      ...
      <div class="row">
          <div class="col-xl-12">
            ...
            <div class="row">
               <div class="col-lg-12">
                 <form  action="<?php echo base_url() ?>admin/farmer_type/update" method="post" role="form" enctype="multipart/form-data"  >
                  <div class="card">
                  ...
                  <div class="col-sm-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input type="text"  class="form-control form-control-sm" id="name" name="name" placeholder="Farmer Type Name*" value="<?php echo $edit_data->title;?>" required>
                              </div>
                           </div>
                       </div>
