                  ...
                  <div class="card">
                      ...
                      <h5 class="card-header bg-success text-white border-bottom ">
                         <div class="row ">
                          ...
                          <a class="btn btn-primary float-end btn-sm"  href="<?php echo base_url(); ?>admin/call_type/addnew"><i class="fa fa-plus"></i> Add New</a>
        ...
        //$('#example').DataTable();
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/call_type/delete",
            currentRow = $(this);
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/call_type/ajax_list')?>",
            "type": "POST"
        },
    ...
    jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/call_type/statusChange",
            currentRow = $(this);
