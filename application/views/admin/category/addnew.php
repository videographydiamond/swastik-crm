   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="row">
               <div class="col-lg-12">
                  <form  action="<?php echo base_url() ?>admin/category/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                     <div class="card">
                           ...
                           <div class="row">
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Enter Category Name"  required="" value="<?php echo set_value('name'); ?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
