                  ...
                  <div class="card">
                      ...
                      <h5 class="card-header bg-success text-white border-bottom ">
                         <div class="row ">
                          ...
                          <?php 
                              $add_btn = (@$action_requred->create=='create')?'<a class="btn btn-primary  float-end btn-sm" href="'.base_url().'admin/category/addnew"><i class="fa fa-plus"></i> Add New</a>':"";
                              echo $add_btn;
                            ?>
    ...
    jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/category/statusChange",
            currentRow = $(this);
