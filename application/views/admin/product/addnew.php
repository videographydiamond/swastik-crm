...
<select class="form-control form-control-sm select2" name="category_id" id="category_id" required >
                       ...
                       <div class="col-sm-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Enter Product Name"  required="">
                              </div>
                           </div>
                       </div>
                 <div class="col-sm-3">
                       ...
                       <div class="col-sm-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input type="text" class="form-control form-control-sm" id="price" name="price" placeholder="Enter price"  required="">
                              </div>
                           </div>
                       </div>
