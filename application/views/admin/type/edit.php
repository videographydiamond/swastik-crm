...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <a href="<?php echo base_url();?>admin/type"> <i class="fa fa-sitemap" aria-hidden="true"></i> Type</a>
        <small>Edit</small>
      </h1>
    </section>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                   ...
                   <form role="form" id="member_form" action="<?php echo base_url() ?>admin/type/update" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <!--Type Name-->                             
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name ="name" class="form-control" required="required" placeholder="Enter Type Name" value="<?php echo $edit_data->name; ?>" >
                                    </div> 
                                    <!--Type Icon-->                             
                                    <div class="form-group">
