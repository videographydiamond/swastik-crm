                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add New Crop Type</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
      ...
      <div class="row">
          <div class="col-xl-12">
            ...
            <div class="row">
               <div class="col-lg-12">
                 <form  action="<?php echo base_url() ?>admin/crop_type/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                  <div class="card">
                  ...
                  <div class="col-sm-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input type="text"  class="form-control form-control-sm" id="name" name="name" placeholder="Crop Type Name*" value="<?php echo set_value('name')?>" required="">
                              </div>
                           </div>
                       </div>
