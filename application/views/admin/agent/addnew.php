...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         <a href="<?php echo base_url();?>admin/agent"> <i class="fa fa-user" aria-hidden="true"></i> Agent</a>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="member_form" action="<?php echo base_url() ?>admin/agent/insertnow" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <!--Agent Name-->                             
