   ...
   <div class="container-fluid">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     ...
                     <li class="breadcrumb-item"><a   href="<?php echo base_url()?>admin/roles">User Role List</a></li>
                     <li class="breadcrumb-item active">Add New User Role</li>
                  </ol>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="row">
               <div class="col-lg-12">
                  <form  action="<?php echo base_url() ?>admin/admin_roles/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                     <div class="card">
                                          ...
                                          <?php
                                             if(!empty($all_users))
                                             {
                                                 ...
                                                 foreach ($all_users as $all_user) {
                                                     ?>
                                          <option value="<?php echo $all_user->id;?>"> <?php echo ( ($all_user->id)?$all_user->id:'')." ".$all_user->title;?></option>
                                          <?php
                                             }
                                             }
                                             ?>
                                          ...
                                          <?php
                                             if(!empty($all_roles))
                                             {
                                                 ...
                                                 foreach ($all_roles as $all_role) {
                                                     ?>
                                          <option value="<?php echo $all_role->id;?>"> <?php echo $all_role->title;?></option>
                                          <?php
                                             }
                                             }
                                             ?>
