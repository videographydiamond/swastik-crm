<?php
        ...
        $action_requred2 = get_module_role($module_id2['id'],$role_id);
?>
                           ...
                           <div class="col-sm-9 ">
                            <div class="row">
                              <div class="col-sm-12">
                                <div class="float-end">
                                   <?php 
                                      $add_btn = (@$action_requred2->create=='create')?'<a class="btn btn-info btn-sm" href="'.base_url().'admin/attendance/addnew"><i class="fa fa-plus"></i>Attendance Form</a>':"";
                                      echo $add_btn;
                                  ?>
                             ...
                             <table class="display table table-striped align-middle table-nowrap mb-0" cellspacing="0" width="100%" id="example">
                                 ...
                                 <tr>
                                  ...
                                  ?>
                                    ...
                                    <td><?php echo date("h:i:s A", strtotime($value['last_checkin']))?></td>
