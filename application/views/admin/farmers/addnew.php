                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add New Farmers</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
      ...
      <div class="row">
          <div class="col-xl-12">
            ...
            <div class="row">
               <div class="col-lg-12">
                 <form  action="<?php echo base_url() ?>admin/farmers/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                  <div class="card">
                  ...
                  <div class="col-sm-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <input type="text" class="form-control form-control-sm" id="alt_mobile" placeholder="ALT Mobile" name="alt_mobile" value="<?php echo set_value('alt_mobile'); ?>">
                              </div>
                           </div>
                           </div>
                           <div class="col-sm-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <input type="text" class="form-control form-control-sm" id="father_name" placeholder="Father Name" name="father_name" value="<?php echo set_value('father_name'); ?>" >
                              </div>
                           </div>
                           </div>
                  ...
                  <div class="col-sm-3">
                           ...
                           <div class="row">
                              <label for="village" class="col-sm-4 col-form-label">Village</label>
                               <div class="col-sm-8">
                                <textarea class="form-control form-control-sm" id="village" placeholder="Village" name="village" ><?php echo set_value('village'); ?></textarea>
                               </div>
                                    ...
                                    <option value="" selected>Choose Source</option>
                                       ...
                                       if(!empty($lead_sources))
                                       {
                                           foreach ($lead_sources as $lead_source) {
                                               ?>
                                    <option value="<?php echo $lead_source->slug;?>" <?php if(set_value('source')==$lead_source->slug){echo 'selected';} ?>  ><?php echo $lead_source->title;?></option>
                                    <?php
                                       }
                                       }
                                       ?>
                  ...
                  <div class="col-sm-3">
                           <div class="row">
                              <label for="whatsapp" class="col-sm-4 col-form-label">WhatsApp</label>
                               <div class="col-sm-8">
                                 <input type="text" class="form-control form-control-sm" id="whatsapp" placeholder="WhatsApp" name="whatsapp" value="<?php echo set_value('whatsapp'); ?>" >
                              </div>
