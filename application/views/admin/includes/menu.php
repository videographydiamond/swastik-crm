<div class="topnav">
   <div class="container">
      <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
         <div class="navbar-collapse active collapse" id="topnav-menu-content" style="">
                  ...
                  <div class="dropdown-menu active" aria-labelledby="topnav-layout">
                     ...
                     <div class="dropdown active">
                        ...
                        <div class="dropdown-menu active" aria-labelledby="topnav-layout-hori">
                           <a href="layouts-horizontal.html" class="dropdown-item active" key="t-horizontal">Horizontal</a>
