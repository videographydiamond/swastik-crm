            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                   ...
                   <form role="form" id="member_form" action="<?php echo base_url() ?>admin/feature/update" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <!--Feature Name-->                             
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name ="name" class="form-control" required="required" placeholder="Enter Feature Name" value="<?php echo $edit_data->name; ?>" >
                                    </div> 
                                    <!--Feature Icon-->                             
                                    <div class="form-group">
