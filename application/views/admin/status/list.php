        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/status/addnew"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        //$('#example').DataTable();
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/status/delete",
            currentRow = $(this);
          
          var confirmation = confirm("Are you sure to delete this Status ?");
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/status/ajax_list')?>",
            "type": "POST"
        },
    ...
    jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/status/statusChange",
            currentRow = $(this);
