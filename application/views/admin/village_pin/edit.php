   ...
   <div class="container-fluid">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     ...
                     <li class="breadcrumb-item active">Update Village</li>
                  </ol>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="row">
               <div class="col-lg-12">
                  <form  action="<?php echo base_url() ?>admin/village_pin/update" method="post" role="form" enctype="multipart/form-data"  >
                     <div class="card">
                           ...
                           <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <select class="form-control form-control-sm select2" name="district_id" id="district_id" required >
                                          ...
                                          <option value="<?php echo $v->id;?>" <?php if($v->id==@$edit_data->district_id){ echo "selected";}?> ><?php echo $v->name;?></option>
                                          <?php }
                                             }
                                             ?>
                                       </select>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <select class="form-control form-control-sm select2" name="city_id" id="city_id" required >
                                          ...
                                          <option value="<?php echo $v->id;?>" <?php if($v->id==@$edit_data->city_id){ echo "selected";}?> ><?php echo $v->city;?></option>
                                          <?php }
                                             }
                                             ?>
                                       </select>
                              ...
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Enter Tehsil Name*"  required="" style="text-transform: capitalize;" value="<?php echo ($edit_data->name)?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" maxlength="6" class="form-control form-control-sm" id="pincode" name="pincode" placeholder="Enter Pincode*"  required=""  onkeypress="return onlyNumberKey(event)"   value="<?php echo ($edit_data->pincode)?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
