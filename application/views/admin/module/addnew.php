   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="row">
               <div class="col-lg-12">
                  <form  action="<?php echo base_url() ?>admin/modules/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                     <div class="card">
                        ...
                        <div class="card-body">
                           <div class="row">
                                       ...
                                       <select class="form-control form-control-sm select2" name="parent_id" id="parent_id"   >
                                          ...
                                          <?php 
                                             if(!empty($module_list))
                                             {
                                               ...
                                               { ?>
                                          <option value="<?php echo $v->id;?>"   ><?php echo $v->module_name;?></option>
                                          <?php 
                                             }
                                             }
                                             ?>
                              ...
                              <div class="col-sm-3">
                                 <div class="row">
                                    <label for="name" class="col-sm-4 col-form-label">Module Name<span class="text-danger">*</span></label>
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="module_name" name="module_name" placeholder="Enter Module Name"  required="">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-6">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-10"> 
                                       <input type="text" class="form-control form-control-sm" id="module_url" name="module_url" placeholder="Module URL"  required="" value="#">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="orders_with" name="orders_with" placeholder="Enter Order Number"  required="" >
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="icon_name" name="icon_name" placeholder="Enter Icon Class Name" >
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="target" value="" name="target" placeholder="Enter Target "  >
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
