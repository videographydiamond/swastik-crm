                      ...
                      <div class="row">
                        <div class="col-sm-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input class="form-control form-control-sm disabled"  type="text" name="farmer_id" id="farmer_id" value="<?php echo @$edit_data->farmer_id;?>" readonly="">
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <input type="text" class="form-control form-control-sm" id="farmer_name" name="farmer_name" placeholder="Farmers Name*"  required=""  readonly="" value="<?php echo @$edit_data->farmer_name;?>"  />
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="row">
                              <label for="farmer_mobile" class="col-sm-4 col-form-label">Mobile<span class="text-danger">*</span></label>
                              <div class="col-sm-8"> 
                                 <input type="text" class="form-control form-control-sm" id="farmer_mobile" name="farmer_mobile" placeholder="Farmers  Mobile*" required=""  readonly="" value="<?php echo @$edit_data->farmer_mobile;?>"/>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8"> 
                                 <textarea name="address" id="address" class="form-control  form-control-sm" placeholder="Address" readonly ><?php echo @$edit_data->address;?></textarea>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <input type="text" class="form-control form-control-sm" id="crop_area" name="crop_area" placeholder="Crop Area"  value="<?php echo @$edit_data->crop_area;?>" />
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                                 ...
                                 <select hidden  class=" form-control form-control-sm " id="agent_id" name="agent_id" aria-label="Floating label select example" >
                                    <?php
                                       if(!empty($all_agents))
                                       {
                                          ...
                                          {
                                          ?>
                                             <option value="<?php echo $all_agent->id;?>" <?php echo (($all_agent->id== $edit_data->assigned_to)?'selected':'');?> ><?php echo $all_agent->id;?> <?php echo $all_agent->title;?></option>
                                          <?php
                                          }
                                       }
                                       ?>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6">
                                       <div class="mb-3 ">
                                          ...
                                          <input type="text" class="form-control form-control-sm" id="ticket_title" name="ticket_title" placeholder="Ticket Title" value="<?php echo @$edit_data->ticket_title;?>" />
                                       </div>
                                    </div>
                                    <div class="col-sm-6">
                                       <div class="mb-3">
                                             ...
                                             <?php
                                                if(!empty($tickets_status))
                                                {
                                                        foreach ($tickets_status as $ticket_status) {
                                                            ?>
                                             <option value="<?php echo $ticket_status->slug;?>" <?php echo (($ticket_status->slug== $edit_data->ticket_status)?'selected':'')?> ><?php echo $ticket_status->title;?></option>
                                             <?php
                                                }
                                                }
                                                ?>
                                                ...
                                                <?php
                                                   if(!empty($calltypes))
                                                   {
                                                           foreach ($calltypes as $calltype) {
                                                               ?>
                                                <option value="<?php echo $calltype->slug;?>" <?php echo (($calltype->slug==$edit_data->call_type)?'selected':'')?>><?php echo $calltype->title;?></option>
                                                <?php
                                                   }
                                                   }
                                                   ?>
                                    ...
                                    <div class="col-sm-3">
                                       <div class="row">
                                          ...
                                          <div class="col-sm-8">
                                             <input type="date" name="follow_up_date" id="follow_up_date" value="<?php echo (($edit_data->follow_up_date=='0000-00-00')?'':(date('Y-m-d',strtotime($edit_data->follow_up_date))));?>" class="form-control form-control-sm" />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-sm-3">
                                                   ...
                                                   if(!empty($documents_category))
                                                   {
                                                           foreach ($documents_category as $document_category) 
                                                           {
                                                               ...
                                                               <option value="<?php echo $document_category->id;?>" 
                                                                  <?php echo (($document_category->id== $edit_data->document_category_id)?'selected':'')?> ><?php echo $document_category->title;?></option>
                                                               <?php
                                                            }
                                                   }
                                                   ?>
                                       ...
                                       <div class="">
                                          ...
                                          <div class="row">
                                              <div class="upload   col-md-2 ">
                                                <input type="file" id="screenshot" name="screenshot" onchange="readURL(this)" accept='image/*'>
                                                           <label for="screenshot">

                                                               <input type="hidden" name="screenshot_exist_file" value="<?php echo $edit_data->screenshot;?>">
                                                               
                                                                <a class="image-popup-no-margins" href="<?php echo base_url('uploads/admin/document/screenshot/').$edit_data->screenshot;?>" title="ScreenShot" data-source="<?php echo base_url('uploads/admin/document/screenshot/').$edit_data->screenshot;?>">
                                                                  <img id="screenshot_src" class="already_exit_pic" data-name="<?php echo $edit_data->screenshot;?>" src="<?php echo base_url('uploads/admin/document/screenshot/').$edit_data->screenshot;?>" style="height:100%;width:100%;">
                                                               </a>
                                                           </label>
...
if(isset($edit_data->id)){
   ...
   getSubProblem('<?php echo $edit_data->document_category_id?>','<?php echo $edit_data->document_id?>');
