   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="row">
               <div class="col-lg-12">
                  <form  action="<?php echo base_url() ?>admin/agents/update" method="post" role="form" enctype="multipart/form-data"  >
                     <div class="card">
                           ...
                           <div class="row">
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Agents Name*" value="<?php echo $edit_data->name; ?>" />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                       <input type="text" maxlength="12" class="form-control form-control-sm" id="mobile"  name="mobile"  placeholder="Customer Mobile*" value="<?php echo $edit_data->phone; ?>"  />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="email" class="form-control form-control-sm" id="email" placeholder="Email" name="email" value="<?php echo $edit_data->email; ?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="password" class="form-control form-control-sm" id="password" placeholder="Father Name" name="password"  value="<?php echo $edit_data->password; ?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                           ...
                                           <?php
                                             if(!empty($companies))
                                             {
                                                 foreach ($companies as $company) {
                                                     ?>
                                          <option value="<?php echo $company->id;?>" <?php if($edit_data->company_id==$company->id){echo 'selected';}?>  ><?php echo $company->name;?></option>
                                          <?php
                                             }
                                             }
                                             ?>
