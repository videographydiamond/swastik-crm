   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="row">
               <div class="col-lg-12">
                  <form  action="<?php echo base_url() ?>admin/document_category/insertnow" method="post" role="form" enctype="multipart/form-data"  >
                     <div class="card">
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-3">
                                    ...
                                    <label for="name" class="  col-form-label">Category<span class="text-danger">*</span></label>
                                       ...
                                       <input type="text" class="form-control form-control-sm" id="name" name="name" placeholder="Enter Category Name"  required="" value="<?php echo set_value('name'); ?>" required>
                              ...
                              <div class="col-sm-3">
                                    ...
                                    <label for="description" class="  col-form-label">Description</label>
                                       ...
                                       <textarea class="form-control form-control-sm" id="description" name="description" placeholder="About Category" ><?php echo set_value('description'); ?></textarea>
                              ...
                              <div class="col-sm-3">
                                    ...
                                    <label for="status1" class=" col-form-label">Status</label>
                                       ...
                                       <select class="form-control form-control-sm" id="status1" name="status1" style="display: block!important">
                                          <option <?php if(set_value('status1')==1){echo 'selected';} ?> value="1" >Active</option>
                                          <option <?php if(set_value('status1')==0){echo 'selected';} ?> value="0">Inactive</option>
                                       </select>
