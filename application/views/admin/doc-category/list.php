               ...
               <div class="col-lg-12">
                  <div class="card">
                      ...
                      <h5 class="card-header bg-success text-white border-bottom ">
                         ...
                         <a class="btn btn-primary  float-end btn-sm" href="<?php echo base_url(); ?>admin/document_category/addnew"><i class="fa fa-plus"></i> Add New</a>
        ...
        //$('#example').DataTable();
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/document_category/delete",
            currentRow = $(this);
...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/document_category/ajax_list')?>",
            "type": "POST"
        },
    ...
    jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/document_category/statusChange",
            currentRow = $(this);
