...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Zeno Strategics | Admin System Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Zeno Strategics</b><br>Admin System</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>vendor/login/resetPasswordUser" method="post">
        ...
        <a href="<?php echo base_url('vendor/login'); ?>">Login</a><br>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
