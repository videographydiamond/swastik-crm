...
class Customer_call extends BaseController
{
    ...
    public function insertnow()
    {
        ...
        else
        {
                ...
                { 
                 ...
                 if(isset($form_data['id']) && $form_data['id'] !==''){
                    redirect('admin/customer/edit/'.$form_data['id']);
    ...
    public function ajax_list()
    {
		...
		$list = $this->customer_call_model->get_datatables($customer);
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<div class="btn-group">
                        ...
                        <a class="dropdown-item" hidden   href="'.base_url().'admin/customer/edit/'.$currentObj->id.'" >View</a>
        ...
        $output = array(
                        ...
                        "recordsTotal" => $this->customer_call_model->count_all($customer),
                        "recordsFiltered" => $this->customer_call_model->count_filtered($customer),
                        "data" => $data,
                );
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('admin/customer/edit/'.$insertData['id']);
          }  
