...
class Feature extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->loadViews("admin/feature/list", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        $this->loadViews("admin/feature/addnew", $this->global, $data , NULL);
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $currentObj->slug;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'admin/feature/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->loadViews("admin/feature/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('admin/feature/edit/'.$insertData['id']);
          }  
