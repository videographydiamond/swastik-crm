...
class Plan extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->vendorView("vendor/plan/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->vendorView("vendor/plan/addnew", $this->global, NULL , NULL);
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'vendor/plan/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('vendor/plan/edit/'.$insertData['id']);
          }  
