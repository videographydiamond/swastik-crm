...
class Label extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->vendorView("vendor/label/list", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        $this->vendorView("vendor/label/addnew", $this->global, $data , NULL);
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $currentObj->slug;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'vendor/label/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->vendorView("vendor/label/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('vendor/label/edit/'.$insertData['id']);
          }  
