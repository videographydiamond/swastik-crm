...
class Email_template extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->vendorView("vendor/email_template/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->vendorView("vendor/email_template/addnew", $this->global, NULL , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('vendor/email_template/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'vendor/email_template/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('vendor/email_template/edit/'.$insertData['id']);
          }  
