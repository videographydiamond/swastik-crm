...
class Agency extends BaseController
{
    ...
    public function companyprofile()
    {
        ...
        $data['listNationality']    = $this->type_model->listNationality();
        //listStateIndia
        $data['listStateIndia']    = $this->type_model->listStateIndia();
...
// Member list
    ...
    public function add_company_profile()
    {
        $this->isVendorLoggedIn();
        $this->load->library('form_validation');            
        $this->form_validation->set_rules('CompanyTitle','Company Title','required');
        ...
        else
        {
            $insertData = array();
                ...
                $insertData['CompanyDescriptionEn']         = $form_data['CompanyDescriptionEn'];
                $insertData['CompanyDescriptionAr']         = $form_data['CompanyDescriptionAr'];
