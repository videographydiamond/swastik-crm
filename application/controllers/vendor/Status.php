...
class Status extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->vendorView("vendor/status/list", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        $this->vendorView("vendor/status/addnew", $this->global, $data , NULL);
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $currentObj->slug;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'vendor/status/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->vendorView("vendor/status/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('vendor/status/edit/'.$insertData['id']);
          }  
