...
class Sub_category extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->global['pageTitle'] = 'Ale-izba : Sub Category';
        $this->vendorView("vendor/sub_category/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->vendorView("vendor/sub_category/addnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('vendor/sub_category/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'vendor/sub_category/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->vendorView("vendor/sub_category/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('vendor/sub_category/edit/'.$insertData['id']);
          }  
